...
use pdf_translator_core::pdf::{BoundingBox, OverlayOptions, PdfOverlay, TranslationOverlay};
use std::fs;
...
fn main() {
    ...
    let test_overlays = vec![TranslationOverlay {
        bbox: BoundingBox {
            x0: 50.0,
            y0: 50.0,
            x1: 400.0,
    ...
    let result = overlay
        .apply_overlays(&pdf_bytes, 0, &test_overlays)
    ...
    let page_obj = doc
        ...
        .expect("Failed to get page object");
